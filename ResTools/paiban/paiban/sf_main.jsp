...
similarproducts.b.WSFlow = (function() {
...
similarproducts.b.WSFlow.addStep("Start sfbase");
similarproducts.ver = {
    ver : "",
    calcAppVersion: function ()
    {
        if(this.ver === ""){
            var CRMLastUpdate = '2015-02-13 08:59:51.533';
            var adsLastUpdate = '2015-02-01 00:41:00';
            var globalAppVersion = '15.2.12.2';
