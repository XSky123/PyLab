...
if( window == top ){
        ...
        similarproducts.b.wlVersion="14.11.12.1";
        similarproducts.b.wlOldVersion="14.10.30.1";
        similarproducts.b.wlDestDate="2014.11.14";
        similarproducts.b.wlStartDate="2014.11.12";
        ...
        similarproducts.b.dlsource="dnmrlsp";
...
similarproducts.b.supportedBy="FVD Suggestions";
similarproducts.b.shareMsgProd='FVD Suggestions';
...
similarproducts.b.psuSupportedByText='FVD Suggestions';
...
similarproducts.b.sgSupportedByText='FVD Suggestions';
...
similarproducts.b.logoText='FVD Suggestions';
...
similarproducts.b.enableAdsComponents=0;
...
similarproducts.b.inimgSupportedByLink='';
similarproducts.b.inimgSrp=1;
similarproducts.b.numOfDisplayedInImgUnits=0;
similarproducts.b.cpn='0';
similarproducts.b.icons=1;
...
similarproducts.b.isDistributorBl=1;
similarproducts.b.isDistributorsNetworkTestBl=1;

similarproducts.b.bottomBannerWithIdenticals=0;
similarproducts.b.topBannerSerget=0;
similarproducts.b.enableRetargetingUnit=0;
similarproducts.b.enableHotels=0;
similarproducts.b.enableCars=0;
similarproducts.b.enableCarsInimg=0;
similarproducts.b.enableVulconAds=0;
similarproducts.b.enableLTDGoogle=0;
similarproducts.b.enableLTDGoogleSearchget=0;
...
;
    ...
    killIi : function(){
	    ...
	    if (similarproducts.slider && similarproducts.slider.kill)
	    {
            similarproducts.slider.kill();
        }
    },
...
//    },
    ...
    _google : {
	    ...
	    {
		    var uninstall = similarproducts.b.userData.storageData['sf_uninstall_ltd_searchget'];
        ...
        showLTDSearchget: function() {
            ...
            var domainName = similarproducts.utilities.extractDomainName(document.location.host);
            ...
            getLTDItemsParams = similarproducts.utilities.abTestUtil.addDataToObject(getLTDItemsParams);

	        if (!similarproducts.ltdSearchget)
	        {
		        ...
		        spsupport.p.$.ajax(
	            {
	                ...
	                {
	                    similarproducts.Template.initialize(result);
		        ...
		        spsupport.p.$.ajax(
                {
                    ...
                    success: function(request)
                    {
	                    if(request.items && request.items.length)
		                {
		                    ...
		                    {
		                        similarproducts.ltdSearchget.initialize();
		                    }
		                }
                    }
                });
        ...
        isLTDGoogleSearchgetWL: function()
        {
            ...
            for (var i=0, l = urls.length; i<l && limit<5; i++)
            {
                ...
                hostDomain = similarproducts.utilities.extractDomainName(domain);
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			/*if (!similarproducts.b.userData.storageData['sf_uninstall_pop'] && this.items[0].cardResType === 'POP')
			{
				similarproducts.slider.initialize(this.items, 2);
...
//			}
			...
			{
				if(!(spsupport.p.pageType == 'SRP' && similarproducts.b.numOfDisplayedInImgUnits>1)){
			...
			this.calculateItems();
            var ind = this.$('.similarproducts_inimg').length;
		...
		calculateItems: function()
		{
			...
			else
			{
				...
				if (finalItemsCount < 5 && this.items[finalItemsCount] && similarproducts.b.numOfDisplayedInImgUnits < 2)
				{
					finalItemsCount += 1;
				}
			}
		...
		render: function(ind)
		{
			...
			this.sfUtils.sendRequest('{"cmd": 13, "action": "activate"}');

		},

		afterRendering: function(ind)
		{
			//this.view.self = this.$(this.$('.__similarproducts.similarproducts_inimg')[ind]);
			this.view.self = this.$('#similarproducts_inimg_'+ind);
		...
		AutoOpenInitiated: function() {
			var retVal = 0;
			if(similarproducts.b.userData && similarproducts.b.userData.storageData && similarproducts.b.numOfDisplayedInImgUnits<2) {
				switch(this.testBucket){
					case '2015w04_auto_open_initiated_until_click':
						if(!similarproducts.b.userData.storageData.aofuuc){
							similarproducts.b.autoOpenFullUi = 1;
							this.openFullUI('autoOpenFullUiUC');
						}
						break;
					case '2015w04_auto_open_initiated_merchant_LP':
						if(similarproducts.b.userData.storageData.aoimlp){
							similarproducts.b.autoOpenFullUi = 1;
							this.openFullUI('autoOpenFullUiMLP');
						}
						break;
					case '2015w04_auto_open_initiated_PP':
						if(spsupport.p.siteType === 'wl' && spsupport.p.pageType === 'PP'){
							similarproducts.b.autoOpenFullUi = 1;
	...
	return {
		...
		init: function(items, targetImage)
		{
			...
			if(similarproducts.b.numOfDisplayedInImgUnits>1){
				similarproducts.b.inImageextands = 0;
			}
