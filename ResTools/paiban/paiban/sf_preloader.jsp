...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        {
            return /^(IE|CH|ES|US|AU|BE|IT|AT|NO|CA|DE|NL|SE|GB|DK|FR|BR|NZ|AR|MX|CL|CO|RU)$/i.test(similarproducts.b.userData.uc || '');
        }
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "dnmrlsp";
        }
        ...
        similarproducts.checkoutObserver = (function()
{
    ...
    function setABData (data) {
        ...
        similarproducts.b.userData.defaultSessionId = getDefaultSessionId();
	...
	{
        var d = new Date();
        var ID = similarproducts.b.userData.ut.userId.substr(0, 5) + d.getDate() + "" +
            ( d.getMonth() + 1) + "" +
            d.getFullYear() + "" +
            d.getHours() + "" +
            d.getMinutes() + "" +
    ...
    return {
        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist() || similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            similarproducts.userData.createIframe("https://www.superfish.com/ws/", function()
            {
                ...
                if(true || rndSampleTrafficReport < 70){
                    var camSampleTrafficParams = {};
                    var camSampleTrafficQueryString = [];

                    camSampleTrafficParams.userId = similarproducts.b.userData.ut.userId;
                ...
                if(merchantName.indexOf("houzz.com") > -1 || merchantName.indexOf("pinterest.com") > -1){
            		...
            		hpSampleTrafficImg.src = spsupport.pluginDomain + 'trackSession.action?' + hpSampleTrafficQueryString.join('&') + similarproducts.utilities.abTestUtil.getDataString();
                }
                ...
                if(similarproducts.b.qsObj.trackUserData || rndUserDataFlowReport == 1){
            		...
            		userDataFlowImg.src = spsupport.pluginDomain + 'trackSession.action?' + userDataFlowQueryString.join('&') + similarproducts.utilities.abTestUtil.getDataString();
                }

                // Disable WS for Lenovo in not paying countries or bestbuy.com
                if (similarproducts.b.qsObj.dlsource == 'hdrykzc' && (!similarproducts.utilities.blacklistHandler.isPayingCountry() || merchantName === 'bestbuy.com'))
                {
                    return;
                }

                similarproducts.b.inj(window.document, spsupport.pluginDomain + 'sf_code.jsp' + similarproducts.b.initialQS + sfCodeAdditionalParams,1)
            }, "*sfxd*");
